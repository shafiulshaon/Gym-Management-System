...
public class WeightGainWeek4 extends JFrame implements ActionListener, MouseListener, Runnable
{
	...
	public WeightGainWeek4(int MemberId)
	{
    ...
    this.setIconImage(img.getImage());			
		...
		WorkoutTitle = new JLabel("   WEEK 4 : PUSH, PULL, LEGS"); 
	 ...
	 public void start () 
   {
	...
	public void mouseClicked(MouseEvent me)
	{
		...
		else if(b==ButtonDay7)
		{
			...
			OFFDay.setText("<html>Only one day of rest this week.<br>You've definitely earned it.</html>");
		}
