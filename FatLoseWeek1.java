...
public class FatLoseWeek1 extends JFrame implements ActionListener, MouseListener, Runnable
{
	...
	public FatLoseWeek1(int MemberId)
	{
		
	super("Fat Lose Workout");
    ...
    this.setIconImage(img.getImage());			
		...
		WorkoutTitle = new JLabel("WEEK 1 : FULL BODY EXERCISE"); 
		...
		String[][] data = {
						   {" Ex  1 :  DUMBBELL BENCH PRESS         (3 sets)",               "   Bench, Dumbbells"},
						   {" Ex  2 :  LAP PULLDOWN                             (3 sets)",               "   Adjustable Cable Machine, Lat Pulldown Bar"},
						   {" Ex  3 :  OVERHEAD DUMBBELL PRESS (3 sets)",               "   Dumbbells"},
						   {" Ex  4 :  LEG PRESS                                      (3 sets)",                                "   N/A"},
						   {" Ex  5 :  LYING LEG CURL                            (3 sets)",                           "   N/A"},
						   {" Ex  6 :  ROPE PRESSDOWN                      (3 sets)",             "   Adjustable Cable Machine, Rope Attachment"},
						   {" Ex  7 :  BARBELL BICEPS CURL               (3 sets)",                    "   Barbell"},
						   {" Ex  8 :  STANDING CALF RAISE                 (3 sets)",                      "   Box"},
						   {" Ex  9 :  CRUNCH                                           (3 sets)",                                  "   N/A"},
		...
		RulesLabel1 = new JLabel(" NB : Exercise 1 to 8 requires 8 - 12 reps (Repeatations)");
		...
		RulesLabel2 = new JLabel(" NB : Exercise 9 requires 15 reps (Repeatations)");
		...
		RulesLabel3 = new JLabel(" NB : 3 Group of reps = 1 set");
	 ...
	 public void start () 
   {
	...
	public void mouseClicked(MouseEvent me)
	{
		...
		else if(b==ButtonDay2)
		{
			...
			OFFDay.setText("  Today is rest day. Enjoy yourself!");
		}
		...
		else if(b==ButtonDay4)
		{
			...
			jps.setVisible(false);
			OFFDay.setVisible(true);
			OFFDay.setText("    Another rest day? Yes, please.");
		}
		...
		else if(b==ButtonDay6)
		{
			...
			jps.setVisible(false);
			OFFDay.setVisible(true);
			OFFDay.setText("Relax. You've crushed your first week!");
		}
		...
		else if(b==ButtonDay7)
		{
			...
			jps.setVisible(false);
			OFFDay.setVisible(true);
			OFFDay.setText("<html>Seriously, recovery time is important.<br>Wait until tomorrow.</html>");
		}
