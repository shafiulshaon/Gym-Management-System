...
public class MemberHomeFL extends JFrame implements ActionListener, MouseListener, Runnable
{
	
	public static void main(String args[])
	{
		MemberHomeFL obj = new MemberHomeFL(1001);
		obj.setVisible(true);
		obj.run();
	}
	...
	public MemberHomeFL(int MemberId)
	{
    ...
    this.setIconImage(img.getImage());			
		...
		WorkoutTitle = new JLabel("  Monthly Workout Routine (Fat Lose)");
		...
		String[][] data = {
                           ...
                           {"     Hot water", "     Brown rice 1 cup", "     Fruit","     Salad"},
					       {"     Lemon", "     Vegetables", "",""},
                           {"     Cinnamon", "     Sea Fish / Chicken", "",""},
						   {"", "     Dal", "","     Dal"},
	...
	public void mouseClicked(MouseEvent me)
	{
		...
		if(b==ButtonWeek1)
		{
			FatLoseWeek1 FLWeek1 = new FatLoseWeek1(MemberId);
			try{
			this.setVisible(false);
			FLWeek1.setVisible(true);
			FLWeek1.start(); 	
			}catch(Exception ex){}
		...
		{
			FatLoseWeek2 FLWeek2 = new FatLoseWeek2(MemberId);
			try{
			this.setVisible(false);
			FLWeek2.setVisible(true);
			FLWeek2.start(); 	
			}catch(Exception ex){}
		...
		{
			FatLoseWeek3 FLWeek3 = new FatLoseWeek3(MemberId);
			try{
			this.setVisible(false);
			FLWeek3.setVisible(true);
			FLWeek3.start(); 	
			}catch(Exception ex){}
		...
		{
			FatLoseWeek4 FLWeek4 = new FatLoseWeek4(1001);
			try{
			this.setVisible(false);
			FLWeek4.setVisible(true);
			FLWeek4.start(); 	
			}catch(Exception ex){}
