...
public class WeightGainWeek3 extends JFrame implements ActionListener, MouseListener, Runnable
{
	...
	public WeightGainWeek3(int MemberId)
	{
    ...
    this.setIconImage(img.getImage());			
		...
		WorkoutTitle = new JLabel("      WEEK 3 : LOWER BODY"); 
		...
		String[][] data = {
						   {" Ex  1 :  LEG PRESS                                     (3 sets)",               "  Curl Machines"},
						   {" Ex  2 :  LEG EXTENSION                            (3 sets)",               "  Calf Raise Machines"},
						   {" Ex  3 :  SEATED LEG CURL                       (3 sets)",               "  Curl Machines"},
						   {" Ex  4 :  MACHINE PREACHER CURL       (3 sets)",                            "  Curl Machines"},
						   {" Ex  5 :  LYING LEG CURL                            (3 sets)",                           "   N/A"},
						   {" Ex  6 :  ROPE PRESSDOWN                      (3 sets)",             "   Adjustable Cable Machine, Rope Attachment"},
						   {" Ex  7 :  SEATED CALF RAISE                      (3 sets)",                    "   Bench"},
