...
public class CreateInstructor extends JFrame implements ActionListener, MouseListener 
{
	...
	private JLabel LabelTitle, LabelPic, LabelName, LabelAddress, LabelGender, LabelBirthday, LabelUserID, LabelMaritalstatus, LabelBloodGroup, LabelEmail, LabelPhone, LabelPhoto, LabelAdmissionDate , LabelGuardianContact, LabelCourse, LabelBatch;
	...
	private boolean flagName, flagacc, flagDB, flagGender, flagUserId, flagBatch,flagBloodGroup, flagEmail, flagPhone, flagGuardianPhone, flagMaritalStatus, flagAddress, flagCourse, flagPicPath;
	private int Pass, UserID , AdminId;
	
	
	public CreateInstructor(int AdminId)
	{
	
	super("Create Instructor  Account");
	...
	buttonSubmit.setBounds(90,535,130,30);
	...
	buttonBack.setBounds(270,535,130,30);
	...
	buttonUpload.setBounds(152, 482, 65, 20);
	...
	LabelTitle = new JLabel("Instructor Account Form");
	...
	LabelMaritalstatus.setBounds(30, 180, 120, 20);
	...
	LabelCourse.setBounds(30, 450, 120, 20);
	...
	LabelPhoto.setBounds(30, 480, 120, 20);
	...
	courseCombo.setBounds(150, 450, 95, 20);
	...
	if(flagName && flagGender && flagUserId && flagBatch && flagBloodGroup && flagEmail && flagPhone && flagGuardianPhone && flagMaritalStatus && flagAddress && flagCourse && flagPicPath)
	{
	...
	public void insertIntoDB()
	{
		...
		String queryInstructor = "INSERT INTO instructoracc VALUES ("+UserID+",'"+Name+"','"+Gender+"','"+DOB+"','"+MaritalStatus+"','"+ BloodGroup+"','"+ Email+"','"+ Phone+"','"+ Address+"','"+ picPath+"','"+ AddmissionDate+"','"+ PaidDate+"','"+ GuardianPhone+"','"+ Batch+"','"+Course +"');";
